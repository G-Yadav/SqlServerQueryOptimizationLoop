...
// English `lang` config for the vendored parser.js (originally lifted from its test.js).
// This is the single source of truth — edit the JSON below directly if the config changes.
// It's a compiled-in constant rather than an embedded resource because csc silently drops a
// second non-.resx EmbeddedResource alongside parser.js; parser.js stays a faithful embedded resource.
    ...
    public const string Json = """
{
  ...
  "headerpageserverreadahead": "Page Server Read-Ahead Reads",
  "headerloblogical": "LOB Logical Reads",
  "headerlobphysical": "LOB Physical Reads",
  "headerlobpageserver": "LOB Page Server Reads",
  "headerlobreadahead": "LOB Read-Ahead Reads",
  "headerlobpageserverreadahead": "LOB Page Server Read-Ahead Reads",
  ...
  "tableshavescrollbars": "Tables have scrollbars",
  "showexample": "Show Example Statistics IO Output",
  "buttonparse": "Parse",
