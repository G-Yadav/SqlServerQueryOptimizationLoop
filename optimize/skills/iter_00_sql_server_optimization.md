...
## Proc-Specific Findings

*This section is written and updated by the optimization loop. Each entry records what was tried on this specific stored procedure, whether it helped, and why.*

<!-- The loop will append entries here in the format below after each iteration:

### Iteration N — <Technique Name> — ACCEPTED / REJECTED / CORRECTNESS FAILURE
- **What was changed:** ...
- **Hypothesis:** ...
- **Result:** total logical reads X → Y (Z% change)
